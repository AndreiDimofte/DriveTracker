    ...
    struct DriveView: View {
        ...
        @State private var isFollowingUser = true // Tracks whether map is following the user
        @State private var recenterTrigger = false // Tracks whether the button has just been tapped
            ...
            NavigationStack {
                ZStack {
                    ...
                    VStack {
                        ...
                        // Recenter button (shows only when user drags the map)
                        if !isFollowingUser {
                            HStack {
                                Spacer()
                                Button(action: {
